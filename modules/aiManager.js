...
export async function saveSettings(settings) {
    ...
    if (window.electronAPI?.updateAiSettings) {
        try {
            ...
            console.log('Settings synced with main process');
        } catch (error) {
            console.warn('Failed to sync settings with main process:', error);
        }
    }
}
...
export async function savePersonalitySettings(settings) {
    ...
    if (window.electronAPI?.updatePersonality) {
        try {
            ...
            console.warn('Failed to sync personality with main process:', error);
        }
    }
}
...
async function makeOpenAIRequest(message, systemPrompt, settings) {
    ...
    try {
        ...
        console.log('Endpoint:', settings.apiEndpoint);
        ...
        console.log('Response received:', responseContent);
